...
import com.lightmap.Events;
import com.lightmap.LightMapConstants;
import com.lightmap.LightMap;
import com.lightmap.packets.LightMapSettingsS2C;
import com.lightmap.packets.WorldIdC2S;
import com.lightmap.packets.WorldIdS2C;
...
public class ForgeEvents implements Events {
    ...
    public void initEvents(LightMap map) {
        this.map = map;
        LightMapForgeMod.getModEventBus().addListener(this::preInitClient);
        LightMapForgeMod.getModEventBus().addListener(this::registerPackets);
